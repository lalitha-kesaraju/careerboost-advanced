    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 italic serif">Build and analyze your master resume for different roles.</p>
        </div>
        <button 
          ...
          >
            ...
            <div className="relative bg-white w-full max-w-4xl rounded-3xl shadow-2xl p-10 flex flex-col h-[80vh]">
               ...
               <div className="space-y-6 flex-1 overflow-y-auto pr-4">
                  <div>
                    <label className="block text-xs font-bold text-gray-600 uppercase tracking-widest mb-2 font-mono">Resume Name</label>
                    <input 
                      value={newResumeName}
                  ...
                  <div className="flex-1 flex flex-col">
                    <label className="block text-xs font-bold text-gray-600 uppercase tracking-widest mb-2 font-mono">Content (Paste or Write)</label>
                    <textarea 
                      value={newResumeText}
               ...
               <div className="flex justify-end gap-4 mt-8 pt-6 border-t border-gray-100">
                  <button onClick={() => setShowBuilder(false)} className="px-6 py-3 font-medium text-gray-600 hover:text-gray-900 transition-colors">Cancel</button>
                  <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {resumes.map((resume, idx) => (
          ...
          >
            ...
            <p className="text-[10px] text-gray-500 font-mono uppercase italic mb-6">Added {resume.createdAt?.toDate().toLocaleDateString()}</p>
        ...
        {analysisResult && (
          ...
          >
             <div className="flex items-center justify-between">
               ...
               <button onClick={() => setAnalysisResult(null)} className="text-gray-500 hover:text-gray-900 transition-colors uppercase font-mono text-[10px] tracking-widest">Close Report</button>
             </div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="space-y-6">
                   <div className="p-8 bg-[#1A1A1A] rounded-[2rem] text-white">
                       <p className="text-[10px] font-bold text-gray-600 uppercase tracking-widest mb-4">Executive Summary</p>
