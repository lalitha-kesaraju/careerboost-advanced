    ...
    >
        <div className="bg-white rounded-[3rem] p-12 border border-gray-100 shadow-xl space-y-10">
            <div className="flex flex-col items-center text-center space-y-6">
                <div className="w-20 h-20 bg-indigo-600 rounded-[2rem] flex items-center justify-center text-white relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div key={i} className="p-6 bg-gray-50 rounded-3xl flex items-center gap-4 group hover:bg-white hover:shadow-lg transition-all border border-transparent hover:border-indigo-100">
